...
function loadState() {
    const savedAvailable = localStorage.getItem('pl_draft_available');
    const savedResults = localStorage.getItem('pl_draft_results');
...
function saveState() {
    localStorage.setItem('pl_draft_available', JSON.stringify(availableTeams));
    localStorage.setItem('pl_draft_results', JSON.stringify(draftedResults));
}
